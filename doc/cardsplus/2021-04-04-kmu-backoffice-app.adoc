...
Für diesen Beitrag gilt die Prämisse, dass ihr Einsatz wohl überlegt und sinnvoll ist.
...
Je nach Hersteller gibt es mehr oder weniger Möglichkeiten, die Software anzupassen.
In der Regel ist so eine Anpassung aber mit zusätzlichen Kosten verbunden.

1. Die Lizenzen für die Nutzung der Software werden teurer.
...
Diese Dienstpläne werden einmal im Monat vom Unternehmer selbst oder einer Assistentin in seinem Auftrag geprüft, ggfs. nach Rücksprache mit dem Beschäftigten korrigiert und in das System für die Leistungserfassung manuell übertragen.
...
Beim Abschluss eines Auftrages werden die Daten aus dem System für die Leistungserfassung vom Unternehmer selbst oder einer Assistentin in seinem Auftrag manuell in das System für die Buchhaltung übernommen.
