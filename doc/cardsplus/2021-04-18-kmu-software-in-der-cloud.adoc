...
Durch Erfahrung und regelmäßige Beobachtung verbessern sich die Entwickler.
Selbst­organi­siert. 
In kur­zen Zyk­len ent­wickelt sie kunden­wirk­same Inkre­mente, maxi­mal moti­viert durch direktes Feedback vom Kunden.
Durch Iteration, also das ständige Wiederholen von Tätigkeiten, werden Entwickler besser und können in der Folge schneller entwickeln -- mit gleichbleibendem Anspruch an die Qualität der Software.

*Die Software ist vollständig dokumentiert.*
Die Software-Produktion ist auf eine lange Zeit ausgerichtet.
Dafür muss die Software in einem Umfang dokumentiert sein, der ausreicht, um langfristige Wartung zu gewährleisten.
Da aber das Volumen des Auftrags nicht ausreicht, dass im Partnerunternehmen dafür ein permanentes Team vorgehalten wird, muss die Dokumentation so gut sein, dass ein Entwickler sich in kurzer Zeit einarbeiten kann.
