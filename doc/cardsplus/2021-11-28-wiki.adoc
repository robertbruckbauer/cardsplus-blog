...
Am Ende zählt nur, was realisiert wurde.
...
Durch spezielle Markierungen können wichtige Teile aus dem Code in eine Spezifikation eingebettet werden.
...
Code, der in der veröffentlichten Form tatsächlich als Teil der Softwate ausgeführt wird.
Hinweise und Erläuterungen im Wiki erklären, warum es den Code gibt.
Der Code selbst zeigt, wie die Lösung aussieht.
