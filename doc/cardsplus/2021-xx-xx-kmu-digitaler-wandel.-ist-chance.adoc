...
. ServDesk (https://sevdesk.at) bezeichnet sich selbst als Software für Buchhaltung.
...
Für andere Bereiche ist allerdings eine andere Standardsoftware notwendig.
Das führt in vielen Unternehmen zu einem Flickenteppich von Anwendungen unterschiedlicher Hersteller.
Eine Integration ist in der Regel nicht möglich.
